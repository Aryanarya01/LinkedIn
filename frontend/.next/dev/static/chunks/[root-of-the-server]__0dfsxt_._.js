...
const LoginComponent = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$compiler$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["c"])(55);
    if ($[0] !== "14105e238330efe74b30187c158eb0442884e02184ae0348ab5eb4528f6001cd") {
        for(let $i = 0; $i < 55; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "14105e238330efe74b30187c158eb0442884e02184ae0348ab5eb4528f6001cd";
    }
    ...
    let t3;
    if ($[8] !== dispatch || $[9] !== email || $[10] !== name || $[11] !== password || $[12] !== username) {
        t3 = ()=>{
    ...
    const handelRegister = t3;
    const handelLogin = _temp3;
    const t4 = userLoginMethod ? "Sign In" : "Sign Up";
    let t5;
    if ($[14] !== t4) {
    ...
    const t6 = authState.isError ? "red" : "green";
    let t7;
    if ($[16] !== t6) {
        t7 = {
            color: t6
    ...
    const t8 = authState.message?.message;
    let t9;
    if ($[18] !== t7 || $[19] !== t8) {
    ...
    let t10;
    if ($[21] !== userLoginMethod) {
        t10 = !userLoginMethod && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t13;
    if ($[25] !== handelRegister || $[26] !== userLoginMethod) {
        t13 = ()=>{
            if (userLoginMethod) {
                handelLogin();
            } else {
    ...
    const t14 = userLoginMethod ? "Sign In" : "Sign Up";
    let t15;
    if ($[28] !== t14) {
    ...
    let t19;
    let t20;
    if ($[40] !== userLoginMethod) {
        t19 = userLoginMethod ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    const t22 = userLoginMethod ? "Sign Up" : "Sign In";
    let t23;
    if ($[44] !== t22) {
    ...
    let t26;
    if ($[52] !== t18 || $[53] !== t25) {
        t26 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$layout$2f$UserLayout$2f$index$2e$jsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0dfsxt_._.js.map